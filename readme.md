...
The library automatically detects your platform and shell. No configuration needed.
...
- `SHELL` - Override shell detection (Unix)
- `COMSPEC` - Override shell detection (Windows)
